import 'package:adventure_guide/Widgets/quantity_increment_decrement.dart';
import 'package:cloud_firestore/cloud_firestore.dart';
import 'package:flutter/material.dart';
import 'package:adventure_guide/Provider/favorite_provider.dart';
import 'package:adventure_guide/Provider/quantity.dart';
                ...
                children: [
                  ...
                  Row(
                    children: [
                      ...
                      Text(
                        "${widget.documentSnapshot['Weather']} ",
                        style: const TextStyle(
                          fontWeight: FontWeight.bold,
                          fontSize: 12,
                          color: Colors.grey,
                    ...
                    children: [
                      Row(
                        children: [
                          // ingredients images
                          Column(
                            children: widget.documentSnapshot['image']
                                .map<Widget>(
                                  (imageUrl) => Container(
                                    height: 60,
                                    width: 60,
